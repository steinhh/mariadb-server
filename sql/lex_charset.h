...
public:
  ...
  bool raise_if_conflicts_with_context_collation(const Lex_context_collation &)
                                                 const;
  bool merge_exact_charset(Charset_collation_map_st::Used *used,
...
public:
  ...
  */
  bool merge_collation(Charset_collation_map_st::Used *used,
                       const Charset_collation_map_st &map,
  ...
  bool merge_collation_override(Charset_collation_map_st::Used *used,
                                const Charset_collation_map_st &map,
                                const Lex_extended_collation_st &cl)
  {
    switch (cl.type()) {
  ...
  */
  bool merge_context_collation(Charset_collation_map_st::Used *used,
                               const Charset_collation_map_st &map,
                               const Lex_context_collation &cl);
  bool merge_context_collation_override(Charset_collation_map_st::Used *used,
                                        const Charset_collation_map_st &map,
                                        const Lex_context_collation &cl);
  /*
...
public:
  ...
  bool set_charset_collate_default(Charset_collation_map_st::Used *used,
                                   const Charset_collation_map_st &map,
  ...
  CHARSET_INFO *resolved_to_character_set(Charset_collation_map_st::Used *used,
                                          const Charset_collation_map_st &map,
...
public:
  ...
  CHARSET_INFO *resolved_to_context(Charset_collation_map_st::Used *used,
                                    const Charset_collation_map_st &map,
